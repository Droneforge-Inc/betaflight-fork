...
#define TARGET_BOARD_IDENTIFIER "LionBee V2 REV_B"
...
#define RX_EXPRESSLRS_TIMER_INSTANCE                                           \
  TMR2 //( BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(8) | BIT(20) )
...
#define TIMER_PIN_MAPPING TIMER_PIN_MAP(0, LED_STRIP_PIN, 1, 5)
