...
#undef USE_RANGEFINDER_OPTFLOW_MTF
#endif
...
#undef USE_CRSF_V3
#undef USE_DASHBOARD
#undef USE_EMFAT_AUTORUN
#undef USE_EMFAT_ICON
#undef USE_ESC_SENSOR
...
#undef USE_FLASH_MEMORY_MAPPED
#undef USE_FLASH_PY25Q128HA
#undef USE_FLASH_QUADSPI
#undef USE_FLASH_SPI
#undef USE_FLASHFS
#undef USE_FLASH_TOOLS
