...
// Estimate attitude from the virtual IMU; never inject ground-truth attitude.
#define USE_IMU_CALC
...
// This interface exposes one IMU. A second virtual device would overwrite
// virtualGyroDev while the firmware continues reading gyro 1.
