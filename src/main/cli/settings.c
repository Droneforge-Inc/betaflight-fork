...
const char * const lookupTableAccHardware[] = {
    ...
    "BMI160", "BMI270", "LSM6DSO", "LSM6DSV16X", "VIRTUAL", "ICM42622P"
};
...
// PG_ARMING_CONFIG
    ...
    { PARAM_NAME_GYRO_CAL_ON_ARM, VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_ARMING_CONFIG, offsetof(armingConfig_t, gyro_cal_on_arm) },
#ifdef USE_EKF
    { PARAM_NAME_RESET_KINEMATIC_STATE_ON_ARM, VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_ARMING_CONFIG, offsetof(armingConfig_t, reset_kinematic_state_on_arm) },
#endif
